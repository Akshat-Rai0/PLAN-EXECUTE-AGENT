...
export const SPRING_PRESS = { type: 'spring' as const, damping: 20, stiffness: 500, mass: 0.5 }
export const SPRING_STREAM_CARD = { type: 'spring' as const, damping: 22, stiffness: 380, mass: 0.9 }
